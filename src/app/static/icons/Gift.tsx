...
export default function Gift(filled?: boolean): JSX.Element {
  return (
    <>
      <path
        d="M2.5 11C2.5 10.1716 3.17157 9.5 4 9.5H20C20.8284 9.5 21.5 10.1716 21.5 11C21.5 11.8284 20.8284 12.5 20 12.5H4C3.17157 12.5 2.5 11.8284 2.5 11Z"
        stroke="#0E6FFF"
      ...
      <path
        ...
        stroke-linecap="round"
      />
      <path d="M13.5 12.5V20.5" stroke="#0E6FFF" stroke-linecap="round" />
    </>
  );
}
