...
import { WalletNavMode, SendNavMode, TokenWithChain } from '../../../../../types/wallet/types';
...
function TestComponent() {
  const handleTestTransfer = () => {
    const testData = {
      ...
      recipient: {
        addr: '0x6cfa3DFD6c34426382E049dCfaf3326fEBfe52F4',
        domain: 'test.ont.id',
        chainIcon: 'https://testnet.bscscan.com/assets/bsc/images/svg/empty-token.svg?v=25.8.3.1',
      },
      chainId: 97,
